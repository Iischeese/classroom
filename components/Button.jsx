...
function Button({ id, mono, children, primary, link, click, style, noForm }) {
    return link ?
        (
            <Link className="w-full" href={link}>
                <Template id={id} noForm={noForm} black={mono} css={style} action={click} color={primary} text={children} ></Template>
            </Link>
        )
        :
        (
...
function Template({ id, color, text, action, css, black, noForm }) {
    return (
